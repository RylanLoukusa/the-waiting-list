...
const styles = StyleSheet.create({
  ...
  title: { color: colors.ink, fontSize: 32, fontWeight: "900", marginBottom: spacing.md },
  input: { backgroundColor: colors.surface, borderRadius: 999, padding: spacing.md },
  section: { color: colors.ink, fontSize: 20, fontWeight: "900", marginTop: spacing.lg },
});
